...
public class LockSupportDemo3 {
    ...
    public static void main(String[] args) throws InterruptedException {
        FIFOMutex mutex = new LockSupportDemo3().new FIFOMutex();
...
class MyThread extends Thread {
    private String name;
    private LockSupportDemo3.FIFOMutex mutex;
    public static int count;

    public MyThread(String name, LockSupportDemo3.FIFOMutex mutex) {
        this.name = name;
        this.mutex = mutex;
    }
